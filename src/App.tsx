  ...
  return (
    <div>
      ...
      <div className="fixed inset-0 top-10 flex p-3 overflow-hidden text-on-surface">
        ...
        <div className="shrink-0 h-full z-20 bg-surface-container-low rounded-l-[2rem] rounded-r-[0.75rem] mr-[-1.5rem]">
        ...
        */}
        <aside
          className={`
            bg-surface-container z-20 overflow-hidden transition-all duration-300 rounded-r-[2rem] rounded-l-[0.75rem]
