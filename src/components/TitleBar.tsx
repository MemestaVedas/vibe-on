...
export function TitleBar() {
    ...
    return (
        ...
        >
            ...
            {/* Search Bar - positioned toward the right of main content area */}
            <div className="flex-1 flex justify-end pr-8">
                <SearchBar />
            </div>

            {/* Window Controls - M3 Organic Shapes with Dynamic Colors */}
            <div className="flex items-center gap-2 pr-2">
                ...
                {/* Maximize - M3 Very Sunny Shape (Updated) - Uses Primary Color */}
                <button
                    onClick={() => {
