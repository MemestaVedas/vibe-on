                                ...
                                <div key={control.label} className="bg-surface-container rounded-[1.25rem] p-5 border border-white/5 hover:border-white/10 transition-colors">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="flex-1 relative h-6 flex items-center">
                                            ...
                                            {/* Custom Thumb */}
                                            <div
                                                className="absolute w-4 h-4 bg-surface border-2 rounded-full shadow-xs pointer-events-none"
                                                style={{
                                            ...
                                            <div key={preset.id} className="relative group">
                                                ...
                                                {!DEFAULT_PRESET_IDS.has(preset.id) && (
                                                    <button
                                                        ...
                                                        className="absolute -top-1.5 -right-1.5 w-5 h-5 bg-error text-on-error rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all shadow-xs scale-90 hover:scale-100"
                                                    >
                                                        ×
                                                    </button>
                                                )}
                                    ...
                                    <div className="flex flex-col md:flex-row gap-4 items-end bg-surface-container p-4 rounded-xl border border-white/5">
                                        <div className="flex-1 w-full">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-surface-container-high border-transparent rounded-lg px-4 py-2.5 text-sm text-on-surface focus:outline-hidden focus:ring-2 focus:ring-primary/50 transition-all placeholder:text-on-surface-variant/50"
                                            />
                                        </div>
